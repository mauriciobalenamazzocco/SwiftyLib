...
This CocoaPods library helps you perform calculation.
  ...
  spec.homepage     = "https://github.com/mauriciobalenamazzocco/SwiftyLib"
  ...
  spec.author             = { "Mauricio Balena Mazzocco" => "mauriciomazzocco@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/mauriciobalenamazzocco/SwiftyLib.git", :tag => "#{spec.version}" }
